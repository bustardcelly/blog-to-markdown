...
url: 'https://custardbelly.com/blog/2012/02/07/current-workflow-developing-linting-testing-and-distributing-javascript/'
author:
  name: 'todd anderson'
date: '2012-02-07'
---
...
I started dabbling and really getting interested in the idea of modular JavaScript when [I began using the Dojo toolkit](https://custardbelly.com/blog/2011/10/04/massroute-js-dojo-example/). That was back at 1.6.1 release and the use of _dojo.provide_, _dojo.require_ and _dojo.declare_. Now at 1.7, [Dojo](https://custardbelly.com/blog/dojotoolkit.com) is fully compliant with **AMD**. Here is an article discussing **Dojo**’s move to **AMD** compatibility: [http://dojotoolkit.org/features/1.6/async-modules](http://dojotoolkit.org/features/1.6/async-modules). _Just as an aside – you really should check out [Dojo](http://dojotoolkit.org/), particularly if you come from a **Flex** background and have happened upon this post._
...
When it comes to minification and concatenation of **JavaScript** files, there are a handful. When researching the right one to fit into my current development and deployment workflow, I also discovered and kick the tires on some fuller build systems that incorporated min-concat to see if they were something I could use. I highlight a few in the links section of this part as I think they may be beneficial to others, but I stuck with rolling my one build/deployment script mainly due to the dependency (happily and no pun intended ![:)](https://custardbelly.com/blog/wp-includes/images/smilies/icon_smile.gif) ) of [RequireJS](https://custardbelly.com/blog/requirejs.org) in my development.
...
Posted in [AMD](https://custardbelly.com/blog/category/amd/), [JSHint](https://custardbelly.com/blog/category/jshint/), [JavaScript](https://custardbelly.com/blog/category/javascript/), [PhantomJS](https://custardbelly.com/blog/category/phantomjs/), [QUnit](https://custardbelly.com/blog/category/qunit/), [RequireJS](https://custardbelly.com/blog/category/requirejs/), [r.js](https://custardbelly.com/blog/category/r-js/).
